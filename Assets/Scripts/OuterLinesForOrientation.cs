...
public class OuterLinesForOrientation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        float prefabYBounds = prefab.GetComponent<SpriteRenderer>().bounds.size.y;
        ...
        for (int i = 0; i < m_tokenPosition.GetNumberOfBeats()+1; i++)
        {
        ...
        for (int i = 0; i < m_tokenPosition.GetNumberOfTunes()+1; i++)
        {
